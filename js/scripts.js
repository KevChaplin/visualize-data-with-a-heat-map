...
const zColors = []
d3.schemeRdYlBu[9].forEach(color => zColors.unshift(color))
...
fetch("https://raw.githubusercontent.com/freeCodeCamp/ProjectReferenceData/master/global-temperature.json")
  ...
  .then(data => {
    ...
    // List of values for x-axis tick labels - multiples of 10 years.
    var xTickItems = []
    ...
    // var legendTickValues = zScale.quantiles
    ...
    // Plot of cells (rect) for temperature variance (z-axis - colors) per year (x-axis) and month (y-axis)
    svg.selectAll("rect")
        .data(dataset)
        .enter()
        .append("rect")
      ...
      svg.append("g")
          .attr("id", "legend")
          .attr("transform", `translate(${w/2 - legendAxisLength/2}, ${h - padding + 80})`)
          .call(legendAxis)
          .selectAll("rect")
              .data(zColors)
              .enter()
